...
def runner():
    today = (date.today())
    api_key = '14a7987d23234b3d8b4ca61c16611560'

    #base_url = "https://newsapi.org/v2/everything?q={}&from={}&to={}&sortBy=popularity&apiKey={}&language=en"
    base_url = "https://newsapi.org/v2/everything?q={}&from={}&sortBy=publishedAt&apiKey={}&language=en"
    print(base_url)
    start_date_value = str(today - datetime.timedelta(days=30))
    ...
    #url_extractor = base_url.format('sport', start_date_value, end_date_value, api_key)
    url_extractor = base_url.format('NBA', start_date_value, api_key)
    print(url_extractor)
